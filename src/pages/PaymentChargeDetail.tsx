...
export default function PaymentChargeDetail() {
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white rounded-2xl p-8 border border-slate-200 shadow-sm text-center">
          ...
          <h2 className="text-lg font-bold text-slate-900">Cobrança não encontrada</h2>
          <p className="text-xs text-slate-500 mt-2 leading-relaxed">
            {loadError ||
              'O identificador da cobrança é inválido ou o pagamento não foi localizado.'}
          </p>
  ...
  // Wrapper padronizado: limita a largura máxima (max-w-4xl / ~960px) centralizada com margem para evitar tela esticada
  const contentWrapperClass = isAuthenticated
    ? 'max-w-5xl mx-auto space-y-6 animate-in fade-in duration-300'
    : 'w-full max-w-3xl mx-auto my-4 sm:my-8 px-4 sm:px-6 space-y-6 animate-in fade-in duration-300'
